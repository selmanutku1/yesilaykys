              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                ...
                <div className="p-4 bg-gray-50 border border-gray-100 rounded-lg">
                  ...
                  <p className="text-gray-600">
                    ...
                    <strong>Akış:</strong> Koordinatör sisteme yeni onaylı giren katılımcılar için 'Otomatik Odalandır' tuşuna basar. Arkaplandaki algoritmik yapı kızları kız odalarına, erkekleri erkek odalarına, yaş farkı maksimal 2 olacak şekilde ve kronik astım/alerjen durumlarını gruplayarak yataklara dağıtır.
                  </p>
                </div>
                <div className="p-4 bg-gray-50 border border-gray-100 rounded-lg">
