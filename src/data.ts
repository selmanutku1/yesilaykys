...
export const INITIAL_BUNGALOWS: Bungalow[] = [
  // Lider Bungalows (4 pax each)
  { id: 'LDR-1', name: 'Hilal-i Ahdar (Lider 1)', type: 'Lider', capacity: 4, campCenterId: 'C01' },
  { id: 'LDR-2', name: 'Zümrüdüanka (Lider 2)', type: 'Lider', capacity: 4, campCenterId: 'C01' },
  { id: 'LDR-3', name: 'Mavi Kırlangıç (Lider 3)', type: 'Lider', capacity: 4, campCenterId: 'C01' },

  // Standard Bungalows (4 pax each, 30 Bungalows)
  { id: 'STD-1', name: 'Sağlıklı Nesil (STD 1)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-2', name: 'Temiz Gelecek (STD 2)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-3', name: 'Bağımsızlık (STD 3)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-4', name: 'Farkındalık (STD 4)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-5', name: 'Benim Kulübüm (STD 5)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-6', name: 'Temiz Nefes (STD 6)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-7', name: 'Zinde Gençlik (STD 7)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-8', name: 'Kardelen (STD 8)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-9', name: 'Ulu Çınar (STD 9)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-10', name: 'Berrak Zihin (STD 10)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-11', name: 'Özgür İrade (STD 11)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-12', name: 'Esenlik (STD 12)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-13', name: 'Umut Baharı (STD 13)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-14', name: 'İyilik Hareketi (STD 14)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-15', name: 'Gönüllü Elçi (STD 15)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-16', name: 'Yaşam Becerileri (STD 16)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-17', name: 'Temiz Sayfa (STD 17)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-18', name: 'Köklü Çınar (STD 18)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-19', name: 'Fidan (STD 19)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-20', name: 'Sağlık Çemberi (STD 20)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-21', name: 'Sağlıklı Yaşam (STD 21)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-22', name: 'Bilge Çınar (STD 22)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-23', name: 'Yeşil Orman (STD 23)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-24', name: 'Doğal İstasyon (STD 24)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-25', name: 'Karakter Okulu (STD 25)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-26', name: 'Akran Savunuculuğu (STD 26)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-27', name: 'Sevgi ve Saygı (STD 27)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-28', name: 'Bilgi Bahçesi (STD 28)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-29', name: 'Kamp Ateşi (STD 29)', type: 'Standart', capacity: 4, campCenterId: 'C01' },
  { id: 'STD-30', name: 'Mavi Gelecek (STD 30)', type: 'Standart', capacity: 4, campCenterId: 'C01' }
];
...
export const INITIAL_LOGS: SystemLog[] = [
  ...
  { id: 'L02', userId: 'S02', userName: 'Canan Özdemir', userRole: 'Kamp Koordinatörü', action: 'Bungalov Ataması', timestamp: '2026-06-15T10:20:00', details: 'Yiğit Şahin LDR-1 nolu Bungalov, 2 nolu yatağa yerleştirildi.' },
